...
export default function DropdownSorted() {
  return (
    <div className="top-16 text-right">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex items-center w-fit justify-center rounded-md bg-opacity-60 bg-black hover:bg-opacity-100 px-4 py-2 text-sm font-medium text-white  focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            <ListBullets className="mr-5" size={25} />
            Ordernado por: <span className="ml-2">Nome</span>
          </Menu.Button>
        </div>
        <Transition
          as={Fragment}
